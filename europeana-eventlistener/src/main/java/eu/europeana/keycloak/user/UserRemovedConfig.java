...
public class UserRemovedConfig {
    ...
    static final String AUTHSERVERURL = "http://localhost:8080/auth/";
    static final String OIDTokenURL = AUTHSERVERURL + "realms/europeana/protocol/openid-connect/token";
    static final String SET_API_URL = "https://set-api-test.eanadev.org/set/";
    ...
    static final String REQUEST_RECEIVED              = "A problem prevented sending a Delete User Account notification for user ID %s to Slack.";
    ...
    static final  String SLACK_SERVICE_UNAVAILABLE_MESSAGEBODY =
    ...
    static final  String SLACK_FORBIDDEN_MESSAGEBODY           =
    ...
    static final String HTTP_FAILED_TRYING_EMAIL = "Error occurred trying to send the message over HTTP, now trying to send it via email ...";
    static final String HTTP_AND_EMAIL_FAILED = "!IMPORTANT! User account was removed, but failed to send confirmation message to Slack. " +
