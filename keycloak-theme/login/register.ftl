...
<ul id="nav" class="nav justify-content-center">
    <li class="nav-item"> <a href="${url.loginUrl}" target="_self" class="nav-link"> <span>${msg("doLogIn")}</span> </a> </li>
    <li class="nav-item"> <a href="${url.registrationUrl}" class="nav-link nuxt-link-active"> <span>${msg("signup")}</span> </a> </li>
</ul>
<div class="divider">
</div>
<div class="kcform">
    ...
    <form action="${url.registrationAction}" method="post">
        ...
        <div class="${properties.kcFormGroupClass!}">
            <div class="form-check">
                <input type="checkbox" class="form-check-input" id="user.attributes.terms" name="user.attributes.terms" required />
