...
//                                            System.out.println(
//                                                "Record FileDetails FileIds: " + fileDetail.getFileIdS());
//                                            System.out.println(
//                                                "Record FileDetails FileNameS: " + fileDetail.getFileNameS());
...
//                                            System.out.println(
//                                                "Record  SequenceNumber: " + imageUpload.getSequenceNumberS());
//                                        }
...
//                                            System.out.println("Record PricingDetails ToRange: " +
//                                                               pricingDetail.getToRange().toString());
//                                            System.out.println("Record PricingDetails Discount: " +
//                                                               pricingDetail.getDiscount().toString());
//                                            System.out.println("Record PricingDetails ID: " + pricingDetail.getId());
//                                            System.out.println("Record PricingDetails FromRange: " +
//                                                               pricingDetail.getFromRange().toString());
//                                        }
...
//                                            System.out.println(
//                                                "Record Participants Invited: " + participant.getInvited().toString());
...
//                                            System.out.println(
//                                                "Record Participants Participant: " + participant.getParticipant());
//                                            System.out.println(
//                                                "Record Participants Status: " + participant.getStatus());
//                                        }
...
//                                            System.out.println("Record ProductDetails LineTax Percentage: " +
//                                                               lineTax.getPercentage().toString());
//                                            System.out.println(
//                                                "Record ProductDetails LineTax Name: " + lineTax.getName());
//                                            System.out.println("Record ProductDetails LineTax Id: " + lineTax.getId());
//                                            System.out.println("Record ProductDetails LineTax Value: " +
//                                                               lineTax.getValue().toString());
//                                        }
...
//                                            System.out.println(
//                                                "Record Comment CommentedBy: " + comment.getCommentedBy());
//                                            System.out.println("Record Comment CommentedTime: " +
//                                                               comment.getCommentedTime().toString());
//                                            System.out.println(
//                                                "Record Comment CommentContent: " + comment.getCommentContent());
...
//                                            if (owner != null) {
//                                                System.out.println(
//                                                    "Record Attachment Owner User-Name: " + owner.getName());
//                                                System.out.println("Record Attachment Owner User-ID: " + owner.getId());
//                                                System.out.println(
//                                                    "Record Attachment Owner User-Email: " + owner.getEmail());
//                                            }
//                                            System.out.println("Record Attachment Modified Time: " +
//                                                               attachment.getModifiedTime().toString());
//                                            System.out.println(
//                                                "Record Attachment File Name: " + attachment.getFileName());
//                                            System.out.println("Record Attachment Created Time: " +
//                                                               attachment.getCreatedTime().toString());
//                                            System.out.println(
//                                                "Record Attachment File Size: " + attachment.getSize().toString());
//                                            ParentId parentId = attachment.getParentId();
//                                            if (parentId != null) {
//                                                System.out.println(
//                                                    "Record Attachment parent record Name: " + parentId.getName());
//                                                System.out.println(
//                                                    "Record Attachment parent record ID: " + parentId.getId());
//                                            }
//                                            System.out.println("Record Attachment is Editable: " +
//                                                               attachment.getEditable().toString());
...
//                                            System.out.println(
//                                                "Record Attachment seModule: " + attachment.getSeModule());
//                                            modifiedBy = attachment.getModifiedBy();
//                                            if (modifiedBy != null) {
//                                                System.out.println(
//                                                    "Record Attachment Modified By User-Name: " + modifiedBy.getName());
//                                                System.out.println(
//                                                    "Record Attachment Modified By User-ID: " + modifiedBy.getId());
//                                                System.out.println("Record Attachment Modified By User-Email: " +
//                                                                   modifiedBy.getEmail());
//                                            }
...
//                                            if (createdBy != null) {
//                                                System.out.println(
//                                                    "Record Attachment Created By User-Name: " + createdBy.getName());
//                                                System.out.println(
//                                                    "Record Attachment Created By User-ID: " + createdBy.getId());
//                                                System.out.println(
//                                                    "Record Attachment Created By User-Email: " + createdBy.getEmail());
//                                            }
...
//                                    System.out.println(
//                                        "Record Consent CreatedBy Email: " + consentCreatedBy.getEmail());
//                                }
//                                MinifiedUser consentModifiedBy = consent.getModifiedBy();
//                                if (consentModifiedBy != null) {
//                                    System.out.println(
//                                        "Record Consent ModifiedBy Name: " + consentModifiedBy.getName());
//                                    System.out.println("Record Consent ModifiedBy ID: " + consentModifiedBy.getId());
//                                    System.out.println(
//                                        "Record Consent ModifiedBy Email: " + consentModifiedBy.getEmail());
//                                }
...
//                                System.out.println(
//                                    "Record Consent ContactThroughEmail: " + consent.getContactThroughEmail());
//                                System.out.println(
//                                    "Record Consent ContactThroughSocial: " + consent.getContactThroughSocial());
//                                System.out.println(
//                                    "Record Consent ContactThroughSurvey: " + consent.getContactThroughSurvey());
//                                System.out.println(
//                                    "Record Consent ContactThroughPhone: " + consent.getContactThroughPhone());
//                                System.out.println(
//                                    "Record Consent MailSentTime: " + consent.getMailSentTime().toString());
//                                System.out.println(
//                                    "Record Consent ConsentDate: " + consent.getConsentDate().toString());
...
//                                System.out.println(
//                                    "Record Consent DataProcessingBasis: " + consent.getDataProcessingBasis());
//                                // To get custom values
//                                System.out.println(
//                                    "Record Consent Lawful Reason: " + consent.getKeyValue("Lawful_Reason"));
//                            } else {
//                                System.out.println(keyName + ": " + value);
//                            }
//                        }
